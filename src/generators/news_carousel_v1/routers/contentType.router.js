...
/**
 * Content Type Router (News): roteia para o gerador apropriado baseado no tipo de conteúdo
 */
export class ContentTypeRouter {
     ...
     */
    async generate(contentType, blueprint, htmlText, template, input) {
        ...
        return await generator.generate(blueprint, htmlText, template, input);
    }
}
